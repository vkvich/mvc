...
<div class="container mt-4">
    <div class="row">
        <div class="col">
            ...
            <form method="post" action="updateArticle?id=<?=$data['id']?>" enctype="multipart/form-data">
                title : <input type="text" class="form-control" name="title" placeholder="Enter title" required value="<?=$data['title']?>"/><br />
